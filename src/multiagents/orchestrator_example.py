...
from src.llm.llm_ops import query_llm
...
class AgentOrchestrator:
    ...
    def orchestrate_task(self, user_input: str):
        ...
        response_format = {"action":"", "input":"", "next_action":""} #Change this with a BaseModel
        ...
        def get_prompt(user_input):
            return f"""
                ...
                You will need to use the context provided and the user's input to classify the intent and select the appropriate agent.
                ...
                ###Guidelines###
                - Sometimes you might have to use multiple agent's to solve user's unput.
